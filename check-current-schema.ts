...
async function analyzeCurrentSchema() {
  ...
  subcats?.forEach((sub: SubCategory, i: number) => {
  ...
  brands?.forEach((brand: VehicleBrand & { vehicle_type: string }, i: number) => {
  ...
  // Test brand service (skipped: service not implemented)
  console.log("   ⚠️ Brand service not implemented: skipping test");
