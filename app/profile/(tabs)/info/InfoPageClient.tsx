        ...
        try {
          ...
          if (fresh) {
            ...
            setProfile((p) => ({
              ...
              phone: (frec['phone'] as string) || '',
              avatarUrl: (frec['avatar_url'] as string) || p.avatarUrl,
              bio: (frec['bio'] as string) || '',
              address: {
                street: ((frec['address'] as Record<string, unknown>)?.street as string) || '',
                city: ((frec['address'] as Record<string, unknown>)?.city as string) || '',
                zip: ((frec['address'] as Record<string, unknown>)?.zip as string) || '',
                country: ((frec['address'] as Record<string, unknown>)?.country as string) || 'België',
              },
